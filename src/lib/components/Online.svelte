...
{#if $online && hideFirst}
  <div class='bg-green-600 text-white text-sm justify-center items-center flex flex-row online overflow-clip relative z-40 px-4 shrink-0'>
    Back online
  </div>
{:else if !$online}
  <div class='bg-neutral-950 text-white text-sm justify-center items-center flex flex-row top-0 offline overflow-clip relative z-40 px-4 shrink-0'>
    <CloudOff size={16} class='me-2' />
    Offline
  </div>
{:else if $error}
  <div class='bg-red-800 text-white text-sm justify-center items-center flex flex-row top-0 offline overflow-clip relative z-40 px-4 shrink-0 w-full'>
